...
public class DoMath {
	...
	public static void main(String[] args) {
		...
		System.out.println(Calculate.toMixedNum(6, 5));
		System.out.println(Calculate.foil(2, 3, 6, -7, "n"));
		System.out.println(Calculate.isDivisibleBy(7, 9));
		...
		System.out.println(Calculate.round2(5.375));
		...
		System.out.println(Calculate.gcf(14, 21));
		System.out.println(Calculate.sqrt(-8));
		System.out.println(Calculate.quadForm(1, -9, 6));
	}
